...
********************************************************************************
**
**    @file   threatdetect_defines.h
**
********************************************************************************
*/

#ifndef _THREATDETECT_DEFINES_H_
#define _THREATDETECT_DEFINES_H_
...
#define MAX_EVENTS \
    128  // Limiting maximum multiplexing events although up to 256 events can be supported.
#if defined(DRV_OS_UNIX)
